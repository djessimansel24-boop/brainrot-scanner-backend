...
const CONFIG = {
    // ── Assignation ──
    ASSIGNMENT_DURATION: 30000,            // Safety net: if bot crashes, assignment expires in 45s
    COOLDOWN_DURATION: "30000,             // 90s (1min30) — server not re-assigned for 1min30
    AUTO_COOLDOWN_ON_EXPIRE: 30000,       // Same duration if assignment expires (bot crash)
